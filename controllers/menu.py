         ...
         if pagina == "main":
            ...
            if   opcion == "1":
                 ...
                 estudios = getData.getAllEstudios(pEmp.idCompania,
                                                   pEmp.idEmpleado)
                 cuenta = estudios.count()
                 putData.setEmpStatus(pEmp.idCompania,pEmp.idEmpleado,'estudio',cuenta)
                 template_values = {'emp'       : pEmp,
                                    'error'     : opcion,
                                    'estudios'  : estudios,
                                    'cuenta'    : cuenta}
                 ...
                 capacs = getData.getAllCapas(pEmp.idCompania,
                                              pEmp.idEmpleado)
                 cuenta = capacs.count()
                 putData.setEmpStatus(pEmp.idCompania,pEmp.idEmpleado,'capacitacion',cuenta)
                 template_values = {'emp'       : pEmp,
                                    'error'     : opcion,
                                    'capacs'    : capacs,
                                    'cuenta'    : cuenta}
                 ...
                 expers = getData.getAllExpers(pEmp.idCompania,
                                               pEmp.idEmpleado)
                 cuenta = expers.count()
                 putData.setEmpStatus(pEmp.idCompania,pEmp.idEmpleado,'experiencia',cuenta)
                 template_values = {'emp'       : pEmp,
                                    'error'     : opcion,
                                    'expers'    : expers,
                                    'cuenta'    : cuenta}
                 ...
                 habiles = getData.getAllHabiles(pEmp.idCompania,
                                                     pEmp.idEmpleado)
                 cuenta = habiles.count()
                 putData.setEmpStatus(pEmp.idCompania,pEmp.idEmpleado,'habilidad',cuenta)
                 template_values = {'emp'     : pEmp,
                                    'habiles' : habiles,
                                    'error'   : opcion,
                                    'cuenta'  : cuenta}
                 ...
                 hobbies = getData.getAllHobs(pEmp.idCompania,
                                                 pEmp.idEmpleado)
                 cuenta = hobbies.count()
                 putData.setEmpStatus(pEmp.idCompania,pEmp.idEmpleado,'hobbie',cuenta)
                 template_values = {'emp'      : pEmp,
                                    'hobbies'  : hobbies,
                                    'error'    : opcion,
                                    'cuenta'   : cuenta}
